...
from ...interfaces.file_system import IFileSystemService
from ...interfaces.template_engine import ITemplateEngine
from ....core.exceptions.validation import InvalidPathException
