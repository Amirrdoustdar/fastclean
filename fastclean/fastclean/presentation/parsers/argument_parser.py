...
class ArgumentParser:
    ...
    def _add_init_command(self, subparsers) -> None:
        ...
        init_parser = subparsers.add_parser(
            "init", help="Initialize a new FastAPI project"
        )

        init_parser.add_argument("--name", type=str, required=True, help="Project name")
        ...
        init_parser.add_argument(
            "--ci", action="store_true", help="Include CI/CD configuration"
        )
    ...
    def _add_crud_command(self, subparsers) -> None:
        ...
        crud_parser = subparsers.add_parser(
            "crud", help="Generate CRUD operations for an entity"
        )

        crud_parser.add_argument(
            "entity", type=str, help="Entity name (e.g., Product, Order)"
        )
    ...
    def _add_feature_command(self, subparsers) -> None:
        ...
        feature_parser = subparsers.add_parser(
            "feature", help="Add feature to existing project"
        )
